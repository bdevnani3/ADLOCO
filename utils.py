...
def copy_current_codebase_to_path(path):
    ...
    to_exclude = [
        ...
        "/nethome/bdevnani3/flash1/long_tail_lang/results_sklearn",
        "/nethome/bdevnani3/flash1/long_tail_lang/results_proj",
        "/nethome/bdevnani3/flash1/long_tail_lang/runs",
        "/nethome/bdevnani3/flash1/long_tail_lang/embedding_datasets",
    ]
    extensions_to_exclude = [".pth", ".pt", ".npy", ".pkl", ".txt", ".json", ".csv"]
